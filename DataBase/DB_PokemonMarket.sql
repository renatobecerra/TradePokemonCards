...
ALTER TABLE Reseñas DROP FOREIGN KEY FK_Reseña_Usuario;
ALTER TABLE Reseñas CHANGE COLUMN ID_Usuario ID_Usuario_Reseñador INT NOT NULL;
ALTER TABLE Reseñas ADD COLUMN ID_Usuario_Reseñado INT NULL AFTER ID_Usuario_Reseñador;
ALTER TABLE Reseñas ADD COLUMN Calificacion INT NOT NULL DEFAULT 5 AFTER ID_Item;
ALTER TABLE Reseñas MODIFY COLUMN ID_Item INT NULL;
ALTER TABLE Reseñas ADD CONSTRAINT FK_Reseña_Usuario_Reseñador FOREIGN KEY (ID_Usuario_Reseñador) REFERENCES usuario (ID_Usuarios);
ALTER TABLE Reseñas ADD CONSTRAINT FK_Reseña_Usuario_Reseñado FOREIGN KEY (ID_Usuario_Reseñado) REFERENCES usuario (ID_Usuarios);